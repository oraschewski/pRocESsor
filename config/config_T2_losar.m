...
% Filenames
cfg.fileProc    = 'T2_LOSAR_filtered.mat';      % Processed output data file
...
cfg.slopeMax        = 30;           % Slope range boundaries for 'linefit'
cfg.slopeInterval   = 0.2;          % Slope range interval for 'linefit' 
